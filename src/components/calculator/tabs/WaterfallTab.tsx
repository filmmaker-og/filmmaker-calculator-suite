  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="flex items-center justify-between animate-fade-in">
        <div className="flex items-center gap-2 text-gold text-xs font-mono uppercase tracking-widest">
          <FileText className="w-3 h-3" />
          <span>Waterfall Results</span>
        </div>
        <a href="/waterfall-info" className="text-xs text-gold-cta hover:text-gold transition-colors flex items-center gap-1">
          Learn how waterfalls work
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-2 mb-6">
          <div
            className={cn(
              "relative p-3 text-center overflow-hidden border",
              isProfitable
                ? "bg-gold-subtle border-gold/30"
          ...
          >
            {isProfitable && (
              <div
                ...
                style={{ background: 'radial-gradient(circle at center bottom, rgba(212,175,55,0.15) 0%, transparent 70%)' }}
              />
            )}
            ...
            <p
              className={cn(
                "relative font-mono text-lg font-bold",
                isProfitable ? "text-gold" : "text-text-dim"
              )}
              style={isProfitable ? { textShadow: '0 0 12px rgba(212,175,55,0.4)' } : undefined}
            >
          ...
          >
            ...
            <p
              ...
              style={result.multiple >= 1.2 ? { textShadow: '0 0 12px rgba(212,175,55,0.4)' } : undefined}
            >
