      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-12">
        ...
        <div className="text-center max-w-4xl mb-12 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl leading-none mb-6 tracking-tight">
            ...
            <br />
            <span className="text-foreground">INSTITUTIONAL</span>
            <br />
            <span className="text-foreground">FILM FINANCE</span>
          </h1>
        ...
        <div className="flex flex-col items-center gap-4 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          ...
          <Button
            ...
            className="btn-vault px-8 py-6 text-lg rounded-none group"
            size="lg"
          >
        ...
        {/* Trust Indicators */}
        <div className="mt-20 flex flex-col items-center gap-4 animate-fade-in" style={{ animationDelay: "0.6s" }}>
