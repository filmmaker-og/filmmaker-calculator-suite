...
const Index = () => {
  ...
  const wfCardStyle = (mode: string, tier?: string): React.CSSProperties => {
    ...
    const base: React.CSSProperties = {
      ...
      background: "linear-gradient(180deg, rgba(220,38,38,0.03), #18181A)",
    ...
    <>
      ...
      <div style={{ minHeight: "100vh", background: "linear-gradient(180deg, #0C0C0E 0%, #111113 50%, #0E0E10 100%)", paddingTop: "24px", maxWidth: "1000px", margin: "0 auto", position: "relative", overflow: "hidden" }}>
        ...
        <section ref={heroRef} style={{ position: "relative", padding: "0 clamp(14px, 4vw, 40px) 8px" }}>
          ...
          <div style={{ background: "linear-gradient(180deg, rgba(212,175,55,0.10), #18181A)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.15)", boxShadow: "inset 0 -1px 0 rgba(212,175,55,0.06)", borderRadius: "6px", padding: "32px 24px 28px", textAlign: "center" }}>
        ...
        <section ref={previewRef} style={{ padding: "0 clamp(14px, 4vw, 40px)", marginBottom: "0" }}>
          <div style={{
            ...
            <div style={{ background: "linear-gradient(180deg, rgba(212,175,55,0.06), #18181A)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.15)", boxShadow: "inset 0 -1px 0 rgba(212,175,55,0.06)", borderRadius: "6px", padding: "28px 24px", marginBottom: "20px", textAlign: "center" }}>
            ...
            <div style={{
              minWidth: "280px", background: "linear-gradient(180deg, rgba(212,175,55,0.03), #18181A)", border: "1px solid rgba(255,255,255,0.06)",
            ...
            <div style={{
              minWidth: "200px", background: "linear-gradient(180deg, rgba(60,179,113,0.03), #18181A)", border: "1px solid rgba(255,255,255,0.06)",
            ...
            {/* Card 3: Profit Split */}
            <div style={{
              minWidth: "220px", background: "linear-gradient(180deg, rgba(212,175,55,0.03), #18181A)", border: "1px solid rgba(255,255,255,0.06)",
              borderRadius: "8px", padding: "24px", scrollSnapAlign: "start", flexShrink: 0,
              boxShadow: "0 4px 16px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.05)",
            }} className="preview-card">
              ...
              <div style={{ display: "flex", gap: "8px", marginBottom: "12px" }}>
                <div style={{ flex: 1, textAlign: "center", padding: "10px 8px", borderRadius: "6px", background: "#16161A", border: "1px solid rgba(60,179,113,0.15)" }}>
            ...
            <div style={{
              minWidth: "240px", background: "linear-gradient(180deg, rgba(212,175,55,0.03), #18181A)", border: "1px solid rgba(255,255,255,0.06)",
              borderRadius: "8px", padding: "24px", scrollSnapAlign: "start", flexShrink: 0,
              boxShadow: "0 4px 16px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.05)",
            }} className="preview-card">
        ...
        <section ref={stakeRef} style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          ...
          <div style={{ ...reveal(stakeVisible), background: "linear-gradient(180deg, rgba(212,175,55,0.06), #18181A)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.15)", boxShadow: "inset 0 -1px 0 rgba(212,175,55,0.06)", borderRadius: "6px", padding: "28px 24px", marginBottom: "20px", textAlign: "center" }}>
            ...
            {stakeCards.map((card, i) => (
              <div
                ...
                style={{
                  ...
                  background: "linear-gradient(180deg, rgba(212,175,55,0.03), #18181A)",
                  border: "1px solid rgba(255,255,255,0.10)",
        ...
        <section style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          ...
          <div
            ref={realityQuoteRef}
            style={{
              background: "linear-gradient(180deg, rgba(212,175,55,0.04), #18181A)",
              border: "1px solid rgba(255,255,255,0.10)",
              borderTop: "1px solid rgba(255,255,255,0.15)",
              borderRadius: "8px",
              padding: "28px 24px",
          ...
          <div ref={realityGridRef} style={{
            ...
            {/* Header — WITH */}
            <div style={{
              background: "linear-gradient(180deg, rgba(60,179,113,0.05), #18181A)",
              padding: "18px 22px",
            ...
            {/* Header — WITHOUT */}
            <div style={{
              background: "linear-gradient(180deg, rgba(220,38,38,0.05), #18181A)",
              padding: "18px 22px",
        ...
        <section ref={socialRef} style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          ...
          <div style={{ ...reveal(socialVisible), background: "linear-gradient(180deg, rgba(212,175,55,0.06), #18181A)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.15)", boxShadow: "inset 0 -1px 0 rgba(212,175,55,0.06)", borderRadius: "6px", padding: "28px 24px", marginBottom: "20px", textAlign: "center" }}>
        ...
        <section ref={closerRef} style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          <div style={{
            ...
            {/* Header band */}
            <div style={{ background: "linear-gradient(180deg, rgba(212,175,55,0.08), #18181A)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.15)", boxShadow: "inset 0 -1px 0 rgba(212,175,55,0.06)", borderRadius: "6px", padding: "32px 24px", marginBottom: "24px", textAlign: "center" }}>
              <h2 style={{
                fontFamily: "'Bebas Neue', sans-serif",
