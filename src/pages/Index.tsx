...
const Index = () => {
  ...
  const wfCardStyle = (mode: string, tier?: string): React.CSSProperties => {
    ...
    const base: React.CSSProperties = {
      ...
      background: "linear-gradient(180deg, rgba(220,38,38,0.03), #121214)",
    ...
    <>
      ...
      <div style={{ minHeight: "100vh", background: "linear-gradient(180deg, #0C0C0E 0%, #111113 50%, #0E0E10 100%)", paddingTop: "24px", maxWidth: "1000px", margin: "0 auto", position: "relative", overflow: "hidden" }}>
        ...
        <section ref={heroRef} style={{ position: "relative", padding: "0 clamp(14px, 4vw, 40px) 8px" }}>
          ...
          <div style={{ background: "linear-gradient(180deg, rgba(212,175,55,0.06), #121214)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.10)", borderRadius: "6px", padding: "32px 24px 28px", textAlign: "center" }}>
        ...
        <section ref={previewRef} style={{ padding: "0 clamp(14px, 4vw, 40px)", marginBottom: "0" }}>
          <div style={{
            ...
            <div style={{ background: "linear-gradient(180deg, rgba(212,175,55,0.06), #121214)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.10)", borderRadius: "6px", padding: "28px 24px", marginBottom: "20px", textAlign: "center" }}>
            ...
            <div style={{
              minWidth: "280px", background: "linear-gradient(180deg, rgba(212,175,55,0.03), #121214)", border: "1px solid rgba(255,255,255,0.06)",
            ...
            <div style={{
              minWidth: "200px", background: "linear-gradient(180deg, rgba(60,179,113,0.03), #121214)", border: "1px solid rgba(255,255,255,0.06)",
            ...
            {/* Card 3: Profit Split */}
            <div style={{
              minWidth: "220px", background: "linear-gradient(180deg, rgba(212,175,55,0.03), #121214)", border: "1px solid rgba(255,255,255,0.06)",
              borderRadius: "6px", padding: "24px", scrollSnapAlign: "start", flexShrink: 0,
              boxShadow: "0 4px 16px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.05)",
            }} className="preview-card">
            ...
            <div style={{
              minWidth: "240px", background: "linear-gradient(180deg, rgba(212,175,55,0.03), #121214)", border: "1px solid rgba(255,255,255,0.06)",
              borderRadius: "6px", padding: "24px", scrollSnapAlign: "start", flexShrink: 0,
              boxShadow: "0 4px 16px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.05)",
            }} className="preview-card">
        ...
        <section ref={(el) => { waterfallSectionRef.current = el; }} style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          ...
          {/* Header band */}
          <div ref={waterfallHeaderRef} style={{ ...reveal(waterfallHeaderVisible), background: "linear-gradient(180deg, rgba(212,175,55,0.06), #121214)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.10)", borderRadius: "6px", padding: "28px 24px", marginBottom: "20px", textAlign: "center" }}>
        ...
        <section ref={stakeRef} style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          ...
          <div style={{ ...reveal(stakeVisible), background: "linear-gradient(180deg, rgba(212,175,55,0.06), #121214)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.10)", borderRadius: "6px", padding: "28px 24px", marginBottom: "20px", textAlign: "center" }}>
            ...
            {stakeCards.map((card, i) => (
              <div
                ...
                style={{
                  ...
                  background: "linear-gradient(180deg, rgba(212,175,55,0.03), #121214)",
                  border: "1px solid rgba(255,255,255,0.10)",
              ...
              >
                ...
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "16px", color: "rgba(250,248,244,0.85)", lineHeight: 1.6 }}>{card.body}</p>
              </div>
            ))}
          </div>
          </div>
            ...
            {withItems.map((withItem, i) => (
              <React.Fragment key={i}>
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "16px", lineHeight: 1.4, color: "rgba(250,248,244,0.85)" }}>{withoutItems[i]}</span>
                </div>
              </React.Fragment>
            ))}
          </div>
        ...
        <section ref={socialRef} style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          ...
          <div style={{ ...reveal(socialVisible), background: "linear-gradient(180deg, rgba(212,175,55,0.06), #121214)", border: "1px solid rgba(255,255,255,0.06)", borderTop: "1px solid rgba(255,255,255,0.10)", borderRadius: "6px", padding: "28px 24px", marginBottom: "20px", textAlign: "center" }}>
        ...
        <section ref={closerRef} style={{ padding: "0 clamp(14px, 4vw, 40px)" }}>
          <div style={{
            ...
            {/* Header band */}
            <div style={{ background: "linear-gradient(180deg, rgba(212,175,55,0.08), #121214)", border: "1px solid rgba(255,255,255,0.08)", borderTop: "1px solid rgba(255,255,255,0.12)", borderRadius: "6px", padding: "32px 24px", marginBottom: "24px", textAlign: "center" }}>
              <h2 style={{
                fontFamily: "'Bebas Neue', sans-serif",
...
const styles: Record<string, React.CSSProperties> = {
  ...
  /* ── § 2 WATERFALL ── */
  waterfallExplainer: {
    fontFamily: "'Inter', sans-serif", fontSize: "18px", color: "rgba(250,248,244,0.85)",
