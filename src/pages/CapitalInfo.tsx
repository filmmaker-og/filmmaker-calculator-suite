        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <WikiCard>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="p-4 font-mono text-[12px] space-y-1 bg-bg-surface rounded-xl border border-gold-border text-ink-body">
                ...
                <div className="pt-2 mt-2 flex justify-between font-semibold border-t border-gold-border">
